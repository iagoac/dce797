...
-  **09/03** - Aula 04: [Funções de recorrência e teorema mestre](slides/aula_04.pdf)
...
-  **18/05** - Aula 29: Apresentação do TP3 - [Disponibilização do TP4](trabalhos/tp_04.pdf)
...
Este repositório no GitHub também servirá como fórum de dúvidas da disciplina. As dúvidas deverão ser postadas na [aba Discussões nesta página](https://github.com/iagoac/dce797/discussions). Desta forma, todos os envolvidos na disciplina (o professor e os outros alunos) poderão ver suas dúvidas e respondelas o mais rápido possível.
